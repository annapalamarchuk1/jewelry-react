    ...
    <div style={{ padding: '60px 8%', minHeight: '70vh', backgroundColor: '#f9f9f9' }}>
      <div style={{ 
        ...
        <img 
          src={product.image} 
          alt={product.title} 
          style={{ width: '400px', borderRadius: '15px', objectFit: 'cover' }} 
        />
        <div style={{ flex: '1', minWidth: '300px' }}>
          <h1 style={{ color: '#1a1a1a', fontSize: '2.5rem' }}>{product.title}</h1>
          <p style={{ fontSize: '1.8rem', color: '#D4AF37', fontWeight: 'bold', margin: '20px 0' }}>
            {product.price} грн
          </p>
